...
public class EventPlanningTest {
  ...
  //   assertEquals(expected, testEventPlanning.runEventPlanning(20, "none"));
  // }
  //
  // @Test
  ...
  //   assertEquals(expected, testEventPlanning.runEventPlanning(50, "none"));
  // }
  //
  // @Test
  ...
  //   assertEquals(expected, testEventPlanning.runEventPlanning(100, "none"));
  // }
  //
  // @Test
  ...
  //   assertEquals(expected, testEventPlanning.runEventPlanning(500, "none"));
  // }
  // @Test
